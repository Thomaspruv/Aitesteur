<x-layouts::auth :title="__('Mot de passe oublié')">
    <div class="flex flex-col gap-6">
        <x-auth-header :title="__('Mot de passe oublié')" :description="__('Saisissez votre email pour recevoir un lien de réinitialisation')" />
        ...
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-at-muted">
            <span>{{ __('Ou, retournez à la') }}</span>
